...
const pillars: PillarCard[] = [
    {
        ...
        text: "We architect systems that scale beyond linear limitations. 10x better, not 10% better."
    },
    {
        num: "02",
        title: "Quantum Integration",
        text: "Seamless fusion of AI intelligence with enterprise infrastructure. Zero friction. Maximum velocity."
    },
    {
        num: "03",
        title: "Infinite Resilience",
        text: "Every layer hardened for global scale. Redundancy as default. Chaos as expected."
    }
];

const PillarCard: React.FC<{ card: PillarCard }> = ({ card }) => {
            ...
            >
                ...
                <div className="relative z-20">
                    <div className="flex justify-between items-center mb-10">
                        <div className="text-[8px] font-black text-cyan-300 tracking-[0.5em] uppercase animate-neon-flicker group-hover:text-cyan-200 transition-colors">PROTOCOL // {card.num}</div>
            ...
            <div className="max-w-[1200px] mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-20 reveal-item transition-all duration-1000 opacity-0 translate-y-8 [&.revealed]:opacity-100 [&.revealed]:translate-y-0">
                    <div className="max-w-xl">
                        <span className="inline-block text-[9px] font-black tracking-[0.5em] text-cyan-400 uppercase mb-6 animate-neon-flicker">Foundation Layer</span>
                        <h2 className="text-4xl lg:text-6xl font-black text-white leading-tight tracking-tight" style={{
                            ...
                            Our Core <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 animate-rainbow-shift" style={{ backgroundSize: '300% auto' }}>Principles.</span>
                        </h2>
                    </div>
                    <p className="max-w-xs text-cyan-200/80 text-lg font-light leading-relaxed hover:text-cyan-100 transition-colors group">
                        The operating axioms that drive how we architect <span className="animate-plasma-wave">exponential solutions.</span>
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {pillars.map((card, i) => <PillarCard key={i} card={card} />)}
                </div>
            </div>
