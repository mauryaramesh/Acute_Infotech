...
const capabilities: CapabilityCard[] = [
    {
        ...
        text: "Deep learning systems that adapt and evolve with your business logic in real-time."
    },
    {
        num: "02",
        title: "Elastic Scaling",
        text: "Multi-region infrastructure that handles 100M+ transactions with zero latency drift."
    },
    {
        num: "03",
        title: "Cognitive Interfaces",
        text: "Human-centric UX that translates silicon complexity into intuitive digital experience."
    },
    {
        num: "04",
        title: "Zero-Knowledge Security",
        text: "Enterprise-grade encryption that proves security without revealing system internals."
    },
];
...
const CapabilityCardComponent: React.FC<CapabilityCardProps> = ({ card }) => {
            ...
            >
                ...
                <div className="relative z-20">
                    <div className="flex justify-between items-center mb-10">
                        <div className="text-[8px] font-black text-cyan-300 tracking-[0.5em] uppercase animate-neon-flicker group-hover:text-cyan-200 transition-colors">CAPABILITY // {card.num}</div>
            ...
            <div className="max-w-[1200px] mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-20 reveal-item transition-all duration-1000 opacity-0 translate-y-8 [&.revealed]:opacity-100 [&.revealed]:translate-y-0">
                    <div className="max-w-xl">
                        <span className="inline-block text-[9px] font-black tracking-[0.5em] text-cyan-400 uppercase mb-6 animate-neon-flicker">Technical Arsenal</span>
                        <h2 className="text-4xl lg:text-6xl font-black text-white leading-tight tracking-tight" style={{
                            ...
                            What We <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500 animate-rainbow-shift" style={{ backgroundSize: '300% auto' }}>Build.</span>
                        </h2>
                    </div>
                    <p className="max-w-xs text-cyan-200/80 text-lg font-light leading-relaxed hover:text-cyan-100 transition-colors group">
                        Our full-stack capabilities that power <span className="animate-plasma-wave">enterprise transformation.</span>
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {capabilities.map((card, i) => <CapabilityCardComponent key={i} card={card} />)}
                </div>
            </div>
